...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // JoystickAxisButton driverRumblerLeft = new
    // JoystickAxisButton(driverController,
    // XBox360Controller.Axis.LEFT_TRIGGER.Number());
    // driverRumblerLeft.whenPressed(new RumbleCommand(Controller.DRIVER,
    // Joystick.RumbleType.kLeftRumble, 1, 1.0));

    // JoystickAxisButton driverRumblerRight = new
    // JoystickAxisButton(driverController,
    // XBox360Controller.Axis.RIGHT_TRIGGER.Number());
    // driverRumblerRight.whenPressed(new RumbleCommand(Controller.DRIVER,
    // Joystick.RumbleType.kRightRumble, 1, 1.0));

    // JoystickAxisButton weaponsRumblerLeft = new
    // JoystickAxisButton(weaponsController,
    // XBox360Controller.Axis.LEFT_TRIGGER.Number());
    // weaponsRumblerLeft.whenPressed(new RumbleCommand(Controller.WEAPONS,
    // Joystick.RumbleType.kLeftRumble, 1, 1.0));

    // JoystickAxisButton weaponsRumblerRight = new
    // JoystickAxisButton(weaponsController,
    // XBox360Controller.Axis.RIGHT_TRIGGER.Number());
    // weaponsRumblerRight.whenPressed(new RumbleCommand(Controller.WEAPONS,
    // Joystick.RumbleType.kRightRumble, 1, 1.0));
